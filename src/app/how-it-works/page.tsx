  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8">
      ...
      <div className="text-center mb-10">
        ...
        <h1 className="text-3xl font-bold text-text-primary mb-2">How GrabLt Protects You</h1>
        <p className="text-text-secondary max-w-xl mx-auto">
          Every transaction on GrabLt is protected by our multi-layer security system.
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
        <div className="bg-surface border border-border rounded-2xl p-5">
          ...
          <p className="text-sm text-text-secondary">
            Money is held by Stripe (a licensed payment processor), not by GrabLt.
